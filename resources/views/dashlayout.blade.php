                ...
                <div class="well sidebar-nav">
                    ...
                    <ul class="nav nav-pills nav-stacked">
                        ...
                        @if(Auth::user()->class >= 3)
                            <li @if(Route::is('editcategory'))class="active"@endif><a href="{{route('editcategory')}}"><i class="glyphicon glyphicon-pencil"></i> Edit Category</a></li>
                            <li @if(Route::is('submitvideo'))class="active"@endif><a href="{{route('submitvideo')}}"><i class="glyphicon glyphicon-upload"></i> Submit Video</a></li>
                        @endif
